...
import handleDeleteCategory from "../../../../pages/Admin/utils/handleDeleteCategory";
...
export default function DeleteCategory({
  ...
  const handleDelete = async () => {
    const result = await handleDeleteCategory(currentCategory.id);
        ...
        <div className="mb-6">
          ...
          {currentCategory && (
            <div className="bg-gray-100 p-3 rounded-md mt-4">
              ...
              <p className="mb-1">
                <span className="font-semibold">ID:</span> {currentCategory.id}
              </p>
