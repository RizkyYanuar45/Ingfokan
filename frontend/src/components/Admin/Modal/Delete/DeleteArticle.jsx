...
import handleDeleteArticle from "../../../../pages/Admin/utils/handleDeleteArticle";
...
export default function DeleteArticle({
  ...
  const handleDelete = async () => {
    const result = await handleDeleteArticle(currentArticle.id);
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-40">
      ...
      <div className="bg-white rounded-lg shadow-xl p-6 max-w-md w-full relative z-50">
        ...
        <div className="mb-6">
          <p className="mb-2">Are you sure you want to delete this article?</p>
          ...
          {currentArticle && (
            <div className="bg-gray-100 p-3 rounded-md mt-4">
              ...
              <p className="mb-1">
                <span className="font-semibold">ID:</span> {currentArticle.id}
              </p>
