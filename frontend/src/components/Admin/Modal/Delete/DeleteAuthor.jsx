...
import handleDeleteAuthor from "../../../../pages/Admin/utils/handleDeleteAuthor";
...
export default function DeleteAuthor({
  ...
  const handleDelete = async () => {
    const result = await handleDeleteAuthor(currentAuthor.id);
        ...
        <div className="mb-6">
          ...
          {currentAuthor && (
            <div className="bg-gray-100 p-3 rounded-md mt-4">
              ...
              <p className="mb-1">
                <span className="font-semibold">ID:</span> {currentAuthor.id}
              </p>
